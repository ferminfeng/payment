...
class WxPayConfig
{
    ...
    public function getConfig(){
        return [
             ...
             * @var path
             */
            'sslcert_path' => VENDOR_PATH . 'payment' . DS . 'src' . DS . 'Wxpay' . DS . 'cert' . DS . 'H5' . DS .'apiclient_cert.pem',
            'sslkey_path' => VENDOR_PATH . 'payment' . DS . 'src' . DS . 'Wxpay' . DS . 'cert' . DS . 'H5' . DS .'apiclient_key.pem',
